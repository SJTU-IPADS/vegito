...
#include "app/analytics/sgc_breakdown.hpp"
...
void LDBCAnalyticsWorker::process_sgc_breakdown_init() {
  
}

bool LDBCAnalyticsWorker::process_sgc_breakdown() {
...
bool LDBCAnalyticsWorker::grape_sgc_breakdown() {
  // UNINPLEMENTED
  return true;
}
