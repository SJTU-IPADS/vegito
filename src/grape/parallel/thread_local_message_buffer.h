...
#ifndef GRAPE_PARALLEL_THREAD_LOCAL_MESSAGE_BUFFER_H_
#define GRAPE_PARALLEL_THREAD_LOCAL_MESSAGE_BUFFER_H_
...
#endif  // GRAPE_PARALLEL_THREAD_LOCAL_MESSAGE_BUFFER_H_
