...
#ifndef GRAPE_WORKER_BATCH_SHUFFLE_WORKER_H_
#define GRAPE_WORKER_BATCH_SHUFFLE_WORKER_H_
...
/**
 * @brief A Worker manages the computation cycle. BatchShuffleAppBase is a kind
 * of worker for apps derived from BatchShuffleAppBase.
 *
 * @tparam APP_T
 */
template <typename APP_T>
class BatchShuffleWorker {
  static_assert(std::is_base_of<BatchShuffleAppBase<typename APP_T::fragment_t,
                                                    typename APP_T::context_t>,
                                APP_T>::value,
                "BatchShuffleWorker should work with BatchShuffleApp");
...
#endif  // GRAPE_WORKER_BATCH_SHUFFLE_WORKER_H_
