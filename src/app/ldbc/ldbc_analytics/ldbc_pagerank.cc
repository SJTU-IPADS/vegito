...
void LDBCAnalyticsWorker::process_pagerank_init() {

}

bool LDBCAnalyticsWorker::process_pagerank() {
  ...
  */
  ...
  std::cout << "[Finish pagerank], "
            ...
            << ", total edges:" << total_active_edges << std::endl;

  return true;
}

bool LDBCAnalyticsWorker::grape_pagerank() {
#ifdef WITH_GRAPE
