...
// 5. order
const int O_CARRIER_ID   = 1;
const int O_C_ID         = 2;
const int O_OL_CNT       = 3;
const int O_ENTRY_D      = 5;
const int O_PR           = 0;
struct oorder {
  struct PACKED_ATTR key {
    uint64_t o_id;
...
// 6. order line
const int OL_PR          = 0;
const int OL_DELIVERY_D  = 1;
const int OL_I_ID        = 2;
const int OL_AMOUNT      = 3;
const int OL_SUPPLY_W_ID = 4;
const int OL_QUANTITY    = 5;
const int OL_C_KEY       = 6;
struct order_line {
  struct PACKED_ATTR key {
    uint64_t ol_id;
  };
