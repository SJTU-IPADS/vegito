...
namespace nocc {
    ...
    public:
      DBFarm(rdmaio::RdmaCtrl *cm,RDMA_sched *sched,MemDB *tables, int t_id,Rpc *rpc,int c_id = 0); // constructor
      ...
      int  add_to_remote_set(int tableid,uint64_t key,int pid, yield_func_t &yield) { return -1; }
